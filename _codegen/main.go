...
var (
	pkg       = flag.String("assert-path", "github.com/ViktorSimko/testify/assert", "Path to the assert package")
...
var headerTemplate = `/*
* CODE GENERATED AUTOMATICALLY WITH github.com/ViktorSimko/testify/_codegen
